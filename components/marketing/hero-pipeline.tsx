...
function ScanSweep() {
  return (
    <motion.span
      ...
      className="pointer-events-none absolute inset-y-0 w-[2px] bg-accent shadow-[0_0_26px_6px_rgba(255,255,255,0.35)]"
    />
  );
}
              ...
              <div className="relative h-[3px] rounded-full bg-white/15">
                ...
                {moments.map(([a, b], i) => (
                  <motion.span
                    ...
                    className="absolute inset-y-0 origin-left rounded-full bg-accent shadow-[0_0_10px_rgba(255,255,255,0.5)]"
                  />
                ))}
              </div>
            </div>
  ...
  return (
    <div className="relative flex h-full min-h-0 flex-1 flex-col">
      ...
      {!still && (
        <div
          aria-hidden
          className="pointer-events-none absolute inset-x-0 -top-24 bottom-0 bg-[radial-gradient(55%_60%_at_50%_20%,rgba(255,255,255,0.10),transparent_70%)] blur-3xl"
        />
      )}
            ...
            >
              ...
              {active && (
                <motion.span
                  ...
                  className="absolute inset-0 rounded-full bg-[linear-gradient(180deg,#ffffff_0%,#e4e4e7_100%)] shadow-[0_0_28px_-6px_rgba(255,255,255,0.45)]"
                />
              )}
              <span
